...
<div class="breadcrumb-panel">
	<div class="ui breadcrumb">
		...
		<i class="right chevron icon divider"></i>
		<div class="active section">View Company Linkages</div>
	</div>
</div>
      ...
      <div class="column">
        ...
        <h2 class="ui header">
          <i class="browser icon"></i>
            <div class="content">Company Linkages
                <a class="item" href="<?php echo site_url("site/admin_tab/{$add_company}"); ?>">
        ...
        <div class="ui icon fluid input">
            ...
            <table class="table demo metro-blue" data-filter="#filter" data-page-size="5">
                ...
                <tr>
                            ...
                            <th data-toggle="true">Contact Number</th>
                ...
                <tr>
                            ...
                            <td>
                              <?php echo form_open('site/edit_user');?>
                                ...
                                <input type="hidden" name="edit_type" value="company">
