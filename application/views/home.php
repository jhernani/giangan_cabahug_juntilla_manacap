...
<li><p>Test and evaluate the effectiveness of the system.</p></li>
        ...
        <div class="six wide right floated column">
          <img src="<?php echo base_url(); ?>assets/images/profile/teambunal.jpg" class="ui large bordered rounded image">
        </div>
      </div>
  ...
  <div id="contact" class="ui vertical stripe quote segment">
    <div class="ui equal width stackable internally celled grid">
      <div class="align-left">
        <div class="column">
          <h3>Contact Us</h3>
         <iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="1150" height="443" src="https://maps.google.com/maps?hl=en&q=University of San Carlos,Nasipit,Talamban,Cebu City&ie=UTF8&t=satellite&z=19&iwloc=B&output=embed"></iframe>
        </div>
      </div>
    </div>
...
<!-- FOOTER -->
  ...
  <div class="ui inverted vertical small footer segment">
<center>&copy; TEAM BUNAL <?php echo date("Y") ?></center>
  </div>
