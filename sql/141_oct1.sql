...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 03, 2015 at 01:25 PM
...
(15, '10303759', 'Chris Evert Lloyd', 'Oro', 'Mañacap', '2622232', '1993-11-28', 'Active', 'Male', 0, 0, 'BS-ICT', 5.7, 'Roman Catholic', 'Single', 'Cebu City', 90, 'Filipino', 'Bario Luz, Cebu City', 'manacapchrisevertlloyd@gmail.com', 'chris1', 'chris1_thumb', '.jpg'),
(16, '10304308', 'Zedrick Jade', 'Difuntorum', 'Juntilla', '0000', '1994-06-01', 'Active', 'Male', 0, 0, 'BS-ICT', 5.6, 'Roman Catholic', 'Single', 'Cebu City', 0, 'Filipino', 'Casia, Bankal, Lapu-Lapu City', 'zedrickjuntilla@gmail.com', '', '', ''),
...
`award_id` int(11) NOT NULL,
  ...
  `award_month` varchar(15) NOT NULL,
...
(3, 'elumba', 'Elumba Technologies', 'elumba@gmail.com', '2302930', 'Active', 'UP Cebu', 'zzz', 'elumba.com', 'accenture1', 'accenture1_thumb', '.png'),
...
`org_id` int(11) NOT NULL,
  ...
  `org_month_in` varchar(15) NOT NULL,
  `org_year_in` year(4) NOT NULL,
  `org_month_out` varchar(15) NOT NULL,
  `org_year_out` year(4) NOT NULL,
...
`project_id` int(11) NOT NULL,
  ...
  `start_date` date NOT NULL,
  `end_date` date NOT NULL,
  `proj_url` varchar(100) NOT NULL,
  `proj_desc` varchar(255) NOT NULL,
  `proj_member_id` int(11) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;
...
INSERT INTO `projects` (`project_id`, `alumni_id`, `project_name`, `position`, `start_date`, `end_date`, `proj_url`, `proj_desc`, `proj_member_id`) VALUES
(1, 14, 'Career Seeker', 'Project Leader', '2015-09-01', '2015-10-31', 'careerseeker.com', 'Team Bunal for the win.', 0),
(2, 14, 'Test', 'Web Dev', '2015-10-13', '2015-10-23', 'test.com', 'test test', 0);
...
ALTER TABLE `job_post`
 ADD PRIMARY KEY (`id`), ADD KEY `category` (`category`), ADD KEY `alumni_id` (`company_id`);
...
--
ALTER TABLE `job_post`
ADD CONSTRAINT `job_post_ibfk_2` FOREIGN KEY (`category`) REFERENCES `job_category` (`category_name`),
