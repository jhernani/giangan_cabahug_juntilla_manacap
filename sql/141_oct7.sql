...
--
-- Host: localhost
-- Generation Time: Oct 06, 2015 at 09:33 PM
...
(14, '10301201', 'Kenneth Francis', 'Miaga', 'Giangan', '09088673605', '1993-05-28', 'Active', 'Male', 0, 0, 'BS-ICT', 5, 'Roman Catholic', 'Single', 'Cebu City', 60, 'Filipino', 'Talamban, Cebu City', 'francisgiangan@gmail.com', 'francis', 'francis_thumb', '.jpg'),
(15, '10303759', 'Chris Evert Lloyd', 'Oro', 'Mañacap', '2622232', '1993-11-28', 'Active', 'Male', 0, 0, 'BS-ICT', 5.7, 'Roman Catholic', 'Single', 'Cebu City', 90, 'Filipino', 'Bario Luz, Cebu City', 'manacapchrisevertlloyd@gmail.com', 'chris', 'chris_thumb', '.jpg'),
(16, '10304308', 'Zedrick Jade', 'Difuntorum', 'Juntilla', '0000', '1994-06-01', 'Inactive', 'Male', 0, 0, 'BS-ICT', 5.6, 'Roman Catholic', 'Single', 'Cebu City', 0, 'Filipino', 'Casia, Bankal, Lapu-Lapu City', 'zedrickjuntilla@gmail.com', 'zed', 'zed_thumb', '.jpg'),
(17, '11104523', 'Stanley', 'Macoy', 'Cabahug', '0000', '1994-09-22', 'Active', 'Male', 0, 0, 'BS-ICT', 5.8, 'Roman Catholic', 'Single', 'Cebu City', 54, 'Filipino', 'Casuntingan, Mandaue City', 'stan_youme@yahoo.com.ph', 'stanley', 'stanley_thumb', '.jpg');
...
(3, 'elumba', 'Elumba Technologies', 'elumba@gmail.com', '2302930', 'Active', 'UP Cebu', 'OH YEAH!', 'elumba.com', 'elumba', 'elumba_thumb', '.png'),
(4, 'accenture', 'Accenture', 'accenture@gmail.com', '2652256', 'Active', 'IT Park', 'Accenture is one of the world’s leading professional services companies, with capabilities in strategy, consulting, digital, technology and operations.', 'www.accenture.com', 'accenture', 'accenture_thumb', '.png');
...
(1, 'Design', 'Design Associate', 'Basic skills in Adobe Packages, such as Photoshop and Illustrator.', 3, 'Pending', 99, '2015-09-09', 'Female', 18, 'Less than 1 year', 'Photoshop,Illustrator'),
(2, 'Information Technology', 'Codeigniter Programmer', 'super cool programmer with cool codeigniter programming grammar', 3, 'Pending', 1000, '2015-09-09', 'Both', 69, '1 - 3 years', 'CodeIgniter'),
(3, 'Information Technology', 'Web Developer', 'Back-end & Front End..', 4, 'Pending', 100000, '2015-10-30', 'Male', 21, '1 - 3 years', 'Semantic-UI');
